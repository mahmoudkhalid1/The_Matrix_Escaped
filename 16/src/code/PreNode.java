...
public class PreNode implements Comparable<PreNode> {
	...
	public int depth;
	//used to specify which cost should be used as a priority 
	public String searchType;
	
	public PreNode(String action, Location affectedCell, TreeNode prevNode,
			double actualCost, double hCost, String searchType ) {
...
//		 negative integer : If object is less than the specified object (o)
		if (this.searchType.contains("GR")) {
			if(this.hCost > o.hCost)
				return 1;
			else if(this.hCost < o.hCost)
				return -1;
			return 0;
		}else if (this.searchType.contains("UC")) {

...
public class TestMatrixPublic {
	...
	public void testh0() throws Exception {
		...
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid0, solution));
		//path cost: 37.0
		//up,carry,left,takePill,left,carry,up,drop;0;0;43
	}
	...
	public void testh1() throws Exception {
		...
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid1, solution));
		//path cost: 106.0
		//left,up,left,carry,left,left,down,drop,right,up,carry,down,left,drop;0;0;267
	}
	...
	public void testh2() throws Exception {
		...
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid2, solution));
		//path cost: 67.0
		//right,right,carry,up,left,left,left,up,carry,up,drop;0;0;99
	}
	...
	public void testh3() throws Exception {
		...
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid3, solution));
		//path cost: 22616.0
		//kill,down,down,down,left,down,kill,left,kill,left,left,takePill,right,right,right,up,up,up,kill,
		//left,kill,left,left,down,carry,up,right,right,right,down,down,right,down,drop;5;8;8464
		//msh sa7
	...
	public void testh5() throws Exception {
		...
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid5, solution));
		//path cost: 379.0
		//down,left,down,takePill,left,left,left,up,carry,down,down,down,carry,right,right,up,right,
		//right,drop,left,left,down,carry,right,right,up,drop;0;0;322
	}
	...
	public void testh6() throws Exception {
		...
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid6, solution));
		//path cost: 106.0
		//up,carry,down,down,fly,up,up,up,carry,down,down,down,left,drop;0;0;255
	}
	...
	public void testh7() throws Exception {
		...
		//path cost: 352.0
		//down,down,carry,right,takePill,down,carry,up,left,up,left,left,left,down,takePill,up,up,fly,
		//left,carry,right,fly,down,down,down,drop;0;0;987
	...
	public void testh8() throws Exception {
		...
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid8, solution));
		//path cost: 211.0
		//left,left,carry,left,carry,up,right,up,drop,up,left,up,carry,down,right,right,carry,down,left,
		 //drop;0;0;1836
	...
	public void testh9() throws Exception {
		...
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid9, solution));
		//path cost: 1276.0
		//down,down,takePill,left,up,up,fly,right,carry,left,left,left,left,up,carry,up,up,takePill,
		//down,down,down,right,right,right,fly,right,down,drop,left,up,fly,left,left,left,up,up,up,up,
		//carry,down,down,down,down,right,right,right,fly,right,down,drop;0;0;476
	...
	*/
	...
	public void testhz10() throws Exception {
		...
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid10, solution));
		//path cost: 394.0
		//left,up,carry,down,right,right,down,right,carry,down,carry,down,carry,kill,left,left,drop;0;1;2130
	}
